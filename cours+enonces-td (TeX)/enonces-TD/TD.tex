...
\input{chapters/TD_1.tex}     % variables
\clearpage
\input{chapters/TD_2.tex}     % types de données
\clearpage
\input{chapters/TD_3.tex}     % boucles, tests
\clearpage
\input{chapters/TD_4.tex}     % fonctions
\clearpage
\input{chapters/TD_5.tex}     % fonctions
\clearpage
\input{chapters/TD_6.tex}     % fichiers
\clearpage
\input{chapters/TD_7.tex}     % Pandas
\clearpage
\input{chapters/TD_8.tex}     % Pandas
